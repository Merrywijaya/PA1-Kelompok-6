                ...
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 30px">
                            Untuk mengaktifkan akun Anda, silahkan klik tombol di bawah ini.
                        </div>
                        <div style="padding-bottom: 40px; text-align:center;">
                            <a href="https://{{ $token }}" rel="noopener" target="_blank"
                                ...
                                target="_blank">Aktifkan Akun</a>
                        </div>
                        <div style="border-bottom: 1px solid #eeeeee; margin: 15px 0"></div>
                        <div style="padding-bottom: 50px; word-wrap: break-all;">
                            <p style="margin-bottom: 10px;">Tombol tidak dapat di klik? Copy dan paste URL
                                dibawah ini ke browser Anda:</p>
                            </p>
                            <a href="https://{{ $token }}" rel="noopener" target="_blank"
                                style="text-decoration:none;color: #009EF7">https://{{ $token }}</a>
                        </div>
                        <!--end:Email content-->
                        <div style="padding-bottom: 10px">Dengan segala hormat,</div>
                        <br>Admin Sangkar Ni Huta.
            <tr>
                <td align="center" valign="center"
                    style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;">
                    {{-- <p>Floor 5, 450 Avenue of the Red Field, SF, 10050, USA.</p>
                    <p>Copyright ©
                        <a href="https://keenthemes.com" rel="noopener" target="_blank">Keenthemes</a>.
                    </p> --}}
                </td>
            </tr></br>
</div>
